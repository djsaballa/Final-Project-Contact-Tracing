    ...
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
           ...
           3. HOW WE COLLECT DATA
            ...
            - Access to Phone's Photo or Photo File. Traze Contact Tracing also requests access to individual's phone photo to allow selection of image or picture during registration that will form part of his identification together with the Traze QR Code.

            Captured image via phone's camera upon the individual's permission or copied image from phone's photo file, also upon the individual's approval, will be saved locally to individual's phone together with his generated QR Code and personal profile. Traze Contact Tracing retains the captured ID Ppicture or image locally in the individual's phone for his identification. ID picture or uploaded image is not part of the file data in the server that Traze kept for contact tracing.
